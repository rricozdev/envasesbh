...
// export const ChatWindow = ({ messages, isTyping, onOptionClick, onReset }) => {
...
//   return (
//     <div className="flex flex-col h-[410px] w-[350px] bg-white shadow-2xl rounded-t-xl overflow-hidden border">
//       {/* Header */}
//       <div className="bg-primary p-4 text-white flex justify-between items-center">
//         <span className="font-bold">Asistente BH</span>
//         <button
//           onClick={onReset}
...
//                       className="text-xs border border-primary text-primary px-3 py-1 rounded-full hover:bg-primary hover:text-white transition-colors"
//                     >
//                       {opt.label}
//                     </button>
//                   ))}
