...
import SectionSucursales from "@/components/features/contacto/SectionSucursales";
            ...
            <div className="flex flex-col h-full">
              <div className="space-y-4 mb-4">
                ...
                <a
                  ...
                  className="flex items-center gap-3 p-4 bg-surface border border-border rounded-xl hover:border-primary transition-colors"
                >
