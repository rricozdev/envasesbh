export const flowAgua = {
  ...
  cta_agua_todos: {
    ...
    cta: { label: "Ver línea Agua", link: "/catalogo?categoria=Agua" },
    options: [
      { label: "Quiero una cotización", next: "cotizacion_volumen" },
  ...
  cta_agua_mediano: {
    ...
    cta: { label: "Ver envases 500–600 ml", link: "/catalogo?categoria=Agua" },
    options: [
      { label: "Quiero una cotización", next: "cotizacion_volumen" },
      { label: "Volver al inicio", next: "start" },
    ],
  ...
  cta_agua_grande: {
    ...
    cta: { label: "Ver envases 1 lt+", link: "/catalogo?categoria=Agua" },
    options: [
      { label: "Quiero una cotización", next: "cotizacion_volumen" },
      { label: "Volver al inicio", next: "start" },
    ],
